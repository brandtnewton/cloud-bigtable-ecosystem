...
var mockTableSchemaConfig = schemaMapping.NewSchemaMappingConfig(
	...
	[]*schemaMapping.TableConfig{
		schemaMapping.NewTableConfig(
			...
			[]*types.Column{
				{Name: "test_id", TypeInfo: types.TypeVarchar, KeyType: u.KEY_TYPE_PARTITION, IsPrimaryKey: true},
				{Name: "column1", TypeInfo: types.TypeVarchar, KeyType: u.KEY_TYPE_CLUSTERING, IsPrimaryKey: true, PkPrecedence: 1},
				{Name: "column10", TypeInfo: types.TypeVarchar, KeyType: u.KEY_TYPE_CLUSTERING, IsPrimaryKey: true, PkPrecedence: 2},
				{Name: "test_hash", TypeInfo: types.TypeVarchar, KeyType: u.KEY_TYPE_REGULAR},
				{Name: "column2", TypeInfo: types.TypeBlob, KeyType: u.KEY_TYPE_REGULAR},
				{Name: "column3", TypeInfo: types.TypeBoolean, KeyType: u.KEY_TYPE_REGULAR},
			},
		),
		schemaMapping.NewTableConfig(
			"keyspace",
			...
			types.OrderedCodeEncoding,
			[]*types.Column{
				{Name: "name", TypeInfo: types.TypeVarchar, KeyType: u.KEY_TYPE_PARTITION, IsPrimaryKey: true, PkPrecedence: 0},
				{Name: "age", TypeInfo: types.TypeVarchar, KeyType: u.KEY_TYPE_REGULAR},
			},
		),
	},
)
