...
func Test_processCollectionColumnsForPrepareQueries(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			columns: []types.Column{
				{Name: "map_timestamp_float", ColumnFamily: "map_timestamp_float", TypeInfo: datatype.NewMapType(datatype.Timestamp, datatype.Float)},
			},
			variableMetadata: []*message.ColumnMetadata{},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: "1633046400000", ColumnFamily: "map_timestamp_float", TypeInfo: datatype.Float},
			},
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "map_text_timestamp", ColumnFamily: "map_text_timestamp", TypeInfo: datatype.NewMapType(datatype.Varchar, datatype.Timestamp)},
			},
			variableMetadata: []*message.ColumnMetadata{},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: "test", ColumnFamily: "map_text_timestamp", TypeInfo: datatype.Timestamp},
			},
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "map_timestamp_text", ColumnFamily: "map_timestamp_text", TypeInfo: datatype.NewMapType(datatype.Timestamp, datatype.Varchar)},
			},
			variableMetadata: []*message.ColumnMetadata{},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: "1633046400000", ColumnFamily: "map_timestamp_text", TypeInfo: datatype.Varchar},
			},
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "set_timestamp", ColumnFamily: "set_timestamp", TypeInfo: datatype.NewSetType(datatype.Timestamp)},
			},
			variableMetadata: []*message.ColumnMetadata{},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: "1633046400", ColumnFamily: "set_timestamp", TypeInfo: datatype.Bigint},
			},
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "set_double", ColumnFamily: "set_double", TypeInfo: datatype.NewSetType(datatype.Double)},
			},
			variableMetadata: []*message.ColumnMetadata{},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: "6.283", ColumnFamily: "set_double", TypeInfo: datatype.Double},
			},
			want1:   []interface{}{emptyVal},
			want2:   map[string]interface{}{},
			want3:   0,
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "set_float", ColumnFamily: "set_float", TypeInfo: datatype.NewSetType(datatype.Float)},
			},
			variableMetadata: []*message.ColumnMetadata{},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: "6.283", ColumnFamily: "set_float", TypeInfo: datatype.Float},
			},
			want1:   []interface{}{emptyVal},
			want2:   map[string]interface{}{},
			want3:   0,
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "set_text", ColumnFamily: "set_text", TypeInfo: datatype.NewSetType(datatype.Varchar)},
			},
			variableMetadata: []*message.ColumnMetadata{},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: "test", ColumnFamily: "set_text", TypeInfo: datatype.Varchar},
			},
			want1:   []interface{}{emptyVal},
			want2:   map[string]interface{}{},
			want3:   0,
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "set_bigint", ColumnFamily: "set_bigint", TypeInfo: datatype.NewSetType(datatype.Bigint)},
			},
			variableMetadata: []*message.ColumnMetadata{},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: "12372432764", ColumnFamily: "set_bigint", TypeInfo: datatype.Bigint},
			},
			want1:   []interface{}{emptyVal},
			want2:   map[string]interface{}{},
			want3:   0,
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "set_int", ColumnFamily: "set_int", TypeInfo: datatype.NewSetType(datatype.Int)},
			},
			variableMetadata: []*message.ColumnMetadata{},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: "12", ColumnFamily: "set_int", TypeInfo: datatype.Int},
			},
			want1:   []interface{}{emptyVal},
			want2:   map[string]interface{}{},
			want3:   0,
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "map_timestamp_timestamp", ColumnFamily: "map_timestamp_timestamp", TypeInfo: datatype.NewMapType(datatype.Timestamp, datatype.Timestamp)},
			},
			variableMetadata: []*message.ColumnMetadata{},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: "1633046400000", ColumnFamily: "map_timestamp_timestamp", TypeInfo: datatype.Timestamp},
			},
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "map_text_bigint", ColumnFamily: "map_text_bigint", TypeInfo: datatype.NewMapType(datatype.Varchar, datatype.Bigint)},
			},
			variableMetadata: []*message.ColumnMetadata{},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: "test", ColumnFamily: "map_text_bigint", TypeInfo: datatype.Bigint},
			},
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "map_timestamp_int", ColumnFamily: "map_timestamp_int", TypeInfo: datatype.NewMapType(datatype.Timestamp, datatype.Int)},
			},
			variableMetadata: []*message.ColumnMetadata{},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: "1633046400000", ColumnFamily: "map_timestamp_int", TypeInfo: datatype.Int},
			},
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "set_boolean", ColumnFamily: "set_boolean", TypeInfo: datatype.NewSetType(datatype.Boolean)},
			},
			variableMetadata: []*message.ColumnMetadata{},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: "1", ColumnFamily: "set_boolean", TypeInfo: datatype.Boolean},
			},
			want1:   []interface{}{emptyVal},
			want2:   map[string]interface{}{},
			want3:   0,
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "map_text_boolean", ColumnFamily: "map_text_boolean", TypeInfo: datatype.NewMapType(datatype.Varchar, datatype.Boolean)},
			},
			variableMetadata: []*message.ColumnMetadata{},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: "test", ColumnFamily: "map_text_boolean", TypeInfo: datatype.Boolean},
			},
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "map_text_text", ColumnFamily: "map_text_text", TypeInfo: datatype.NewMapType(datatype.Varchar, datatype.Varchar)},
			},
			variableMetadata: []*message.ColumnMetadata{},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: "test", ColumnFamily: "map_text_text", TypeInfo: datatype.Varchar},
			},
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "map_text_int", ColumnFamily: "map_text_int", TypeInfo: datatype.NewMapType(datatype.Varchar, datatype.Int)},
			},
			variableMetadata: []*message.ColumnMetadata{},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: "test", ColumnFamily: "map_text_int", TypeInfo: datatype.Int},
			},
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "map_text_float", ColumnFamily: "map_text_float", TypeInfo: datatype.NewMapType(datatype.Varchar, datatype.Float)},
			},
			variableMetadata: []*message.ColumnMetadata{},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: "test", ColumnFamily: "map_text_float", TypeInfo: datatype.Float},
			},
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "map_text_double", ColumnFamily: "map_text_double", TypeInfo: datatype.NewMapType(datatype.Varchar, datatype.Double)},
			},
			variableMetadata: []*message.ColumnMetadata{},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: "test", ColumnFamily: "map_text_double", TypeInfo: datatype.Double},
			},
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "map_timestamp_boolean", ColumnFamily: "map_timestamp_boolean", TypeInfo: datatype.NewMapType(datatype.Timestamp, datatype.Boolean)},
			},
			variableMetadata: []*message.ColumnMetadata{},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: "1633046400000", ColumnFamily: "map_timestamp_boolean", TypeInfo: datatype.Boolean},
			},
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "map_timestamp_double", ColumnFamily: "map_timestamp_double", TypeInfo: datatype.NewMapType(datatype.Timestamp, datatype.Double)},
			},
			variableMetadata: []*message.ColumnMetadata{},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: "1633046400000", ColumnFamily: "map_timestamp_double", TypeInfo: datatype.Double},
			},
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "map_timestamp_bigint", ColumnFamily: "map_timestamp_bigint", TypeInfo: datatype.NewMapType(datatype.Timestamp, datatype.Bigint)},
			},
			variableMetadata: []*message.ColumnMetadata{},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: "1633046400000", ColumnFamily: "map_timestamp_bigint", TypeInfo: datatype.Bigint},
			},
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "list_text", ColumnFamily: "list_text", TypeInfo: datatype.NewListType(datatype.Varchar)},
			},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: time.Now().Format("20060102150405.000"), ColumnFamily: "list_text", TypeInfo: datatype.Varchar},
			},
			want1:   []interface{}{textValue},
			want2:   map[string]interface{}{},
			want3:   0,
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "list_int", ColumnFamily: "list_int", TypeInfo: datatype.NewListType(datatype.Int)},
			},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: time.Now().Format("20060102150405.000"), ColumnFamily: "list_int", TypeInfo: datatype.Int},
			},
			want1:   []interface{}{intValue},
			want2:   map[string]interface{}{},
			want3:   0,
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "list_bigint", ColumnFamily: "list_bigint", TypeInfo: datatype.NewListType(datatype.Bigint)},
			},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: time.Now().Format("20060102150405.000"), ColumnFamily: "list_bigint", TypeInfo: datatype.Bigint},
			},
			want1:   []interface{}{bigintValue},
			want2:   map[string]interface{}{},
			want3:   0,
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "list_boolean", ColumnFamily: "list_boolean", TypeInfo: datatype.NewListType(datatype.Boolean)},
			},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: time.Now().Format("20060102150405.000"), ColumnFamily: "list_boolean", TypeInfo: datatype.Boolean},
			},
			want1:   []interface{}{trueVal},
			want2:   map[string]interface{}{},
			want3:   0,
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "list_float", ColumnFamily: "list_float", TypeInfo: datatype.NewListType(datatype.Float)},
			},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: time.Now().Format("20060102150405.000"), ColumnFamily: "list_float", TypeInfo: datatype.Float},
			},
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "list_double", ColumnFamily: "list_double", TypeInfo: datatype.NewListType(datatype.Double)},
			},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: time.Now().Format("20060102150405.000"), ColumnFamily: "list_double", TypeInfo: datatype.Double},
			},
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "list_timestamp", ColumnFamily: "list_timestamp", TypeInfo: datatype.NewListType(datatype.Timestamp)},
			},
			values: []*primitive.Value{
			...
			want: []types.Column{
				{Name: time.Now().Format("20060102150405.000"), ColumnFamily: "list_timestamp", TypeInfo: datatype.Bigint},
			},
...
func TestProcessComplexUpdate(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			columns: []types.Column{
				{Name: "map_text_bool_col", TypeInfo: datatype.NewMapType(datatype.Varchar, datatype.Boolean)},
				{Name: "list_text", TypeInfo: datatype.NewListType(datatype.Varchar)},
			},
			values: []interface{}{
				ComplexAssignment{
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "pk_1_text", TypeInfo: datatype.Varchar},
			},
			values: []interface{}{
				"pk_1_text+value",
			},
	...
	tests := []struct {
	...
	}{
		{
			...
			tableConfig: schemaMapping.NewTableConfig("keyspace", "table", "cf1", types.OrderedCodeEncoding, []*types.Column{
				{Name: "user_id", TypeInfo: datatype.Varchar, KeyType: utilities.KEY_TYPE_PARTITION, PkPrecedence: 1},
			}),
		...
		},
		{
			name: "int nonzero",
			tableConfig: schemaMapping.NewTableConfig("keyspace", "table", "cf1", types.OrderedCodeEncoding, []*types.Column{
				{Name: "user_id", TypeInfo: datatype.Bigint, KeyType: utilities.KEY_TYPE_PARTITION, PkPrecedence: 1},
			}),
		...
		},
		{
			name: "int32 nonzero",
			tableConfig: schemaMapping.NewTableConfig("keyspace", "table", "cf1", types.OrderedCodeEncoding, []*types.Column{
				{Name: "user_id", TypeInfo: datatype.Int, KeyType: utilities.KEY_TYPE_PARTITION, PkPrecedence: 1},
			}),
		...
		},
		{
			...
			tableConfig: schemaMapping.NewTableConfig("keyspace", "table", "cf1", types.OrderedCodeEncoding, []*types.Column{
				{Name: "user_id", TypeInfo: datatype.Bigint, KeyType: utilities.KEY_TYPE_PARTITION, PkPrecedence: 1},
				{Name: "other_id", TypeInfo: datatype.Int, KeyType: utilities.KEY_TYPE_PARTITION, PkPrecedence: 2},
				{Name: "yet_another_id", TypeInfo: datatype.Varchar, KeyType: utilities.KEY_TYPE_PARTITION, PkPrecedence: 3},
			}),
		...
		},
		{
			...
			tableConfig: schemaMapping.NewTableConfig("keyspace", "table", "cf1", types.OrderedCodeEncoding, []*types.Column{
				{Name: "user_id", TypeInfo: datatype.Varchar, KeyType: utilities.KEY_TYPE_PARTITION, PkPrecedence: 1},
				{Name: "team_num", TypeInfo: datatype.Bigint, KeyType: utilities.KEY_TYPE_CLUSTERING, PkPrecedence: 2},
				{Name: "city", TypeInfo: datatype.Varchar, KeyType: utilities.KEY_TYPE_CLUSTERING, PkPrecedence: 3},
			}),
			values: map[string]interface{}{
				"user_id":  "user1",
				"team_num": int64(1),
		...
		},
		{
			...
			tableConfig: schemaMapping.NewTableConfig("keyspace", "table", "cf1", types.OrderedCodeEncoding, []*types.Column{
				...
				{Name: "team_num", TypeInfo: datatype.Bigint, KeyType: utilities.KEY_TYPE_CLUSTERING, PkPrecedence: 2},
				{Name: "city", TypeInfo: datatype.Varchar, KeyType: utilities.KEY_TYPE_CLUSTERING, PkPrecedence: 3},
				{Name: "borough", TypeInfo: datatype.Varchar, KeyType: utilities.KEY_TYPE_CLUSTERING, PkPrecedence: 4},
			}),
			values: map[string]interface{}{
				"user_id":  "user3",
				"team_num": int64(3),
		...
		},
		{
			...
			tableConfig: schemaMapping.NewTableConfig("keyspace", "table", "cf1", types.OrderedCodeEncoding, []*types.Column{
				{Name: "user_id", TypeInfo: datatype.Blob, KeyType: utilities.KEY_TYPE_PARTITION, PkPrecedence: 1},
				{Name: "team_id", TypeInfo: datatype.Blob, KeyType: utilities.KEY_TYPE_CLUSTERING, PkPrecedence: 2},
				{Name: "city", TypeInfo: datatype.Blob, KeyType: utilities.KEY_TYPE_CLUSTERING, PkPrecedence: 3},
			}),
			values: map[string]interface{}{
				"user_id": "\xa2",
				"team_id": "",
		...
		},
		{
			...
			tableConfig: schemaMapping.NewTableConfig("keyspace", "table", "cf1", types.OrderedCodeEncoding, []*types.Column{
				{Name: "user_id", TypeInfo: datatype.Blob, KeyType: utilities.KEY_TYPE_PARTITION, PkPrecedence: 1},
				{Name: "team_num", TypeInfo: datatype.Blob, KeyType: utilities.KEY_TYPE_CLUSTERING, PkPrecedence: 2},
				{Name: "city", TypeInfo: datatype.Blob, KeyType: utilities.KEY_TYPE_CLUSTERING, PkPrecedence: 3},
				{Name: "borough", TypeInfo: datatype.Blob, KeyType: utilities.KEY_TYPE_CLUSTERING, PkPrecedence: 4},
			}),
			values: map[string]interface{}{
				"user_id":  "\xa2",
				"team_num": "",
		...
		},
		{
			...
			tableConfig: schemaMapping.NewTableConfig("keyspace", "table", "cf1", types.OrderedCodeEncoding, []*types.Column{
				{Name: "user_id", TypeInfo: datatype.Blob, KeyType: utilities.KEY_TYPE_PARTITION, PkPrecedence: 1},
				{Name: "city", TypeInfo: datatype.Blob, KeyType: utilities.KEY_TYPE_CLUSTERING, PkPrecedence: 2},
			}),
			values: map[string]interface{}{
				"user_id": "\xa5",
				"city":    "\x90",
		...
		},
		{
			...
			tableConfig: schemaMapping.NewTableConfig("keyspace", "table", "cf1", types.OrderedCodeEncoding, []*types.Column{
				{Name: "user_id", TypeInfo: datatype.Varchar, KeyType: utilities.KEY_TYPE_PARTITION, PkPrecedence: 1},
				{Name: "city", TypeInfo: datatype.Varchar, KeyType: utilities.KEY_TYPE_CLUSTERING, PkPrecedence: 2},
				{Name: "borough", TypeInfo: datatype.Varchar, KeyType: utilities.KEY_TYPE_CLUSTERING, PkPrecedence: 3},
			}),
			values: map[string]interface{}{
				"user_id": "nn",
				"city":    "t\x00t",
...
func TestProcessCollectionColumnsForPrepareQueries_ComplexMetaAndNonCollection(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			columnsResponse: []types.Column{
				{Name: "pk_1_text", TypeInfo: datatype.Varchar, ColumnFamily: "cf1"},
			},
			values: []*primitive.Value{
		...
		},
		{
			...
			columnsResponse: []types.Column{
				{Name: "column_int", TypeInfo: datatype.Int, ColumnFamily: "cf1"},
			},
			values: []*primitive.Value{
		...
		},
		{
			...
			columnsResponse: []types.Column{
				{Name: "map_text_text", TypeInfo: datatype.NewMapType(datatype.Varchar, datatype.Varchar), ColumnFamily: "map_text_text"},
			},
			values: []*primitive.Value{
			...
			primaryKeys: []string{},
			wantNewColumns: []types.Column{
				{Name: "newKey", ColumnFamily: "map_text_text", TypeInfo: datatype.Varchar},
			},
		...
		},
		{
			...
			columnsResponse: []types.Column{
				{Name: "list_text", TypeInfo: datatype.NewListType(datatype.Varchar), ColumnFamily: "list_text"},
			},
			values: []*primitive.Value{
		...
		},
		{
			...
			columnsResponse: []types.Column{
				{Name: "set_text", TypeInfo: datatype.NewSetType(datatype.Varchar), ColumnFamily: "set_text"},
			},
			values: []*primitive.Value{
...
func TestProcessComplexUpdate_SuccessfulCases(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			columns: []types.Column{
				{Name: "map_text_text", TypeInfo: datatype.NewMapType(datatype.Varchar, datatype.Varchar)},
			},
			values: []interface{}{
				ComplexAssignment{
		...
		},
		{
			...
			columns: []types.Column{
				{Name: "normal_col", TypeInfo: datatype.Varchar},
			},
...
func TestAddSetElements(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			column: types.Column{
				Name:     "test_set",
				TypeInfo: datatype.NewSetType(datatype.Varchar),
			},
			input:  ProcessRawCollectionsInput{},
			output: &ProcessRawCollectionsOutput{},
			validate: func(t *testing.T, output *ProcessRawCollectionsOutput) {
				...
				assert.Equal(t, datatype.Varchar, output.NewColumns[0].TypeInfo)
		...
		},
		{
			...
			validate: func(t *testing.T, output *ProcessRawCollectionsOutput) {
				...
				for i, val := range expectedValues {
					...
					assert.Equal(t, datatype.Varchar, output.NewColumns[i].TypeInfo)
		...
		},
		{
			...
			column: types.Column{
				Name:     "test_set",
				TypeInfo: datatype.NewSetType(datatype.Boolean),
			},
			input:  ProcessRawCollectionsInput{},
			output: &ProcessRawCollectionsOutput{},
			validate: func(t *testing.T, output *ProcessRawCollectionsOutput) {
				...
				for i, val := range expectedValues {
					assert.Equal(t, val, output.NewColumns[i].Name)
					assert.Equal(t, "test_family", output.NewColumns[i].ColumnFamily)
					assert.Equal(t, datatype.Boolean, output.NewColumns[i].TypeInfo)
					assert.Empty(t, output.NewValues[i])
				}
			},
		},
		...
		},
		{
			...
			column: types.Column{
				Name:     "test_set",
				TypeInfo: datatype.NewSetType(datatype.Int),
			},
			input:       ProcessRawCollectionsInput{},
			output:      &ProcessRawCollectionsOutput{},
			expectedErr: true,
...
func TestHandleListOperation(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			column: types.Column{
				Name:     "mylist",
				TypeInfo: datatype.NewListType(datatype.Int),
			},
			input: ProcessRawCollectionsInput{
			...
			validate: func(t *testing.T, output *ProcessRawCollectionsOutput) {
				...
				for _, col := range output.NewColumns {
					...
					assert.Equal(t, datatype.Int, col.TypeInfo)
				}
			},
		},
		{
...
func TestHandleMapOperation(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			column: types.Column{
				Name:     "mymap",
				TypeInfo: datatype.NewMapType(datatype.Varchar, datatype.Int),
			},
		...
		},
		{
			...
			column: types.Column{
				Name:     "mymap",
				TypeInfo: datatype.NewMapType(datatype.Int, datatype.Int),
			},
...
func TestProcessCollectionColumnsForRawQueries(t *testing.T) {
	...
	colList := types.Column{
		Name:     "list_text",
		TypeInfo: datatype.NewListType(datatype.Varchar),
	}
	colSet := types.Column{
		Name:     "column7",
		TypeInfo: datatype.NewSetType(datatype.Varchar),
