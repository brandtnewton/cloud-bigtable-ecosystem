...
func addParamIfNeeded(value types.DynamicValue, params types.IQueryParameters, needsByteConversion bool, result map[string]bigtable.SQLType) error {
	if value == nil {
		return nil
	}
	...
	md, err := params.GetMetadata(param.Placeholder)
	if err != nil {
		return err
	}
	...
	result[string(param.Placeholder)] = bigtableType
	return nil
}
