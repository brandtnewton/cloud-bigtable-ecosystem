...
/**
 * This SMT is used to flatten nested array fields that can be generated by some serialization
 * libraries. Given the following input message value, with `array.field="products"`
 * `array.inner.wrapper="list"` `array.element.wrapper="element"`
 *
 * <pre>{@code
 * {
 *   "orderId": "order1",
  ...
  public static final ConfigDef CONFIG_DEF =
      new ConfigDef()
          .define(
              ...
              "The name of the root level array field.")
          .define(
              ARRAY_INNER_WRAPPER_FIELD_NAME,
              ConfigDef.Type.STRING,
              ConfigDef.Importance.HIGH,
              "The name of the inner array wrapper field.")
          .define(
              ARRAY_ELEMENT_WRAPPER_FIELD_NAME,
              ConfigDef.Type.STRING,
              ConfigDef.Importance.HIGH,
              "The name of the wrapper field around each array element.");
  ...
  private Field getArrayElementField(Schema schema) {
    ...
    if (innerElementField == null) {
      ...
      throw new DataException(
          "Array element wrapper: '" + elementWrapperFieldName + "' is not a struct");
    }
